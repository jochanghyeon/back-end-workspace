...
public class A_Array {
	...
	public void method1( ) {
		...
		// 정수형 : 0, 실수형 : 0.0, 문자형 : \u0000, 논리형이 : false, 참조형 : null
	 ...
	 * */
		public void method3( ) {
			...
			for(int i = 0; i < cm.length; i++) {
				...
				//System.out.println(Arrays.toString(cm)); //잘 나오는지 확인	
			}
			System.out.printf("%.1f", sum / cm.length);
//			double sum = (180 +177.3 +168.2) /3;
...
//			System.out.println(double);
	...
	// 1) for 문을 이용한 깊은 복사
		public void method5() {
			...
			}copy [1] = 20;// number 값은 바뀌지않고 copy값만 바뀜
		System.out.println(Arrays.toString(number));
		System.out.println(Arrays.toString(copy));
		
		
		}
		// 2) System 클레스에서 제공하는 arraycopy() 메서드를 이용한 깊은 복사
