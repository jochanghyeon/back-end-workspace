...
public class A_TryCatch {
	...
	/*
	 * 컴파일 에러(emopile-time error) : 컴파일 시에 발생하는 에러(실행하기 전부터)
	 ...
	 * 
	 * 에러는 메모리 부족(OutOfMemory Error)이나 스택오버플로우(StackOverflowError)와 같이
...
//			e.printStackTrace();
			// get.Message : 발생한 예외클래스의 객체에 저장된 메시지를 얻을 수 있음
