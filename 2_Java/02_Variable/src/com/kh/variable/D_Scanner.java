...
public class D_Scanner {
	 ...
	 * 	  - 정수일 때 : sc.nextInt()
	 * 	  - 실수일 때 : sc.nextFloate(), sc.nextDouble()
	 * 
...
//		sc.nextLine();
		...
		System.out.printf("당신의 이름은 %s이고 사는 곳은 서울 %s, 나이는 %d살, 키는 %.1fcm, 성별은 %c 입니다.", name, addr, age, height, gender);
//		System.out.printf("당신의 이름은 "+"%s"+" 사는곳 "+"%s"+" 나이는 "+"%s"+" 키는 "+"%.1f"+" 성별은 "+"%c"+" 입니다" ,name ,addr, age, height, gender);
	}
