...
//		 variable.variableTest();
	...
	public void printValue() {
		...
		System.out.println(r * r * pi); // syso 입력후 ctrl + 스페이스바 -> Enter!
	...
	public void variableTest() {
		...
		// 1. 논리형  // 1byte(=8bit) TRUE | FALSE 를 넣을수있음
...
//		ch = 'ab'; 에러 발생! --> 주석 단축키 : ctrl + /
		...
		// 3. 정수형
		byte bNum = 1; // 1byte(=8bit)(-128 ~ 127까지) 256 = 2^8승
//		bNum =128; 에러 발생! -> 오버플로우(Overflow)
		short sNum =128; // 2byte(=16bit)
		int iNum =922337283; // 4byte (기본) 2^32승
		long lNum = 922337283458L; //8byte - 숫자 뒤에L(l)을 입력
...
//		int int;
	...
	public void constant() {
		 ...
		 *  - 상수에 네이밍 규칙은 대문자로 표기를 한다, 여러 단어가 오면 _로 구분
		 * */
		int age = 20;
		age = 25;
