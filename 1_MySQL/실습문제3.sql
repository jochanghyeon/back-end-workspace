...
create table publisher(
    ...
    INSERT INTO publisher(pub_name, phone)
    VALUES ('인사이트', '032-322-5143');
    INSERT INTO publisher(pub_name, phone)
    VALUES ('프리렉', '02-332-0931');
...
bk_price INT,
constraint bk_no_fk FOREIGN KEY(bk_pub_no) 
...
INSERT INTO member(member_id, member_pwd, member_name, gender, address, phone)
values('user03', 'pass02', '라마바', 'M', '서울시 서초구', '010-3333-4444');
INSERT INTO member(member_id, member_pwd, member_name, gender, address, phone)
...
CREATE TABLE rent(
	...
	ALTER TABLE rent ADD CONSTRAINT book_no_fk
		foreign key(rent_book_no) references member(bk_no) ON DELETE SET NULL;
...
JOIN publisher ON(bk_pno_no = pub_no);